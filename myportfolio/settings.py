...
if not DEBUG:
    ...
    AWS_STORAGE_BUCKET_NAME = config('AWS_STORAGE_BUCKET_NAME', default='portfoliojjit')
    AWS_S3_REGION_NAME = config('AWS_S3_REGION_NAME', default='eu-north-1')  # Changed from us-east-1 to eu-north-1
